...
export const constantRoutes = [{
  ...
  // 文章
  {
    ...
    children: [{
      ...
      },
      {
        path: 'history',
        name: 'articleHistory',
        component: () => import('@/views/article/history'),
        meta: {
          title: '历史发布',
        }
      }
  ...
  //教学案例
  {
    ...
    children: [{
        path: 'show',
        name: 'exampleShow',
        component: () => import('@/views/example/show'),
        meta: {
          title: '查看案例',
        }
      },
      {
        path: 'publish',
        name: 'examplePublish',
        component: () => import('@/views/example/publish'),
        meta: {
          title: '发布案例',
        }
      }],
  ...
  //其它
  {
    ...
    children: [{
      path: 'tips',
      name: 'tips',
      component: () => import('@/views/others/tips'),
      meta: {
        title: '小贴士',
      }
    }]
